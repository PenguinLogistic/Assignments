...
if __name__ == '__main__':
    ...
    if(len(s.successors()) == 9):
        ...
        if(totalStates == 9):
            ...
            if (state1 == False):
                print("\t Missing state: 1")
                print("\t", s1_time)
                print("\t", s1_orders)
                print("\t", s1_robots)
            if (state2 == False):
                print("\t Missing state: 2")
                print("\t", s2_time)
                print("\t", s2_orders)
                print("\t", s2_robots)
            if (state3 == False):
                print("\t Missing state: 3")
                print("\t", s3_time)
                print("\t", s3_orders)
                print("\t", s3_robots)
            if (state4 == False):
                print("\t Missing state: 4")
                print("\t", s4_time)
                print("\t", s4_orders)
                print("\t", s4_robots)
            if (state5 == False):
                print("\t Missing state: 5")
                print("\t", s5_time)
                print("\t", s5_orders)
                print("\t", s5_robots)
            if (state6 == False):
                print("\t Missing state: 6")
                print("\t", s6_time)
                print("\t", s6_orders)
                print("\t", s6_robots)
            if (state7 == False):
                print("\t Missing state: 7")
                print("\t", s7_time)
                print("\t", s7_orders)
                print("\t", s7_robots)
            if (state8 == False):
                print("\t Missing state: 8")
                print("\t", s8_time)
                print("\t", s8_orders)
                print("\t", s8_robots)
            if (state9 == False):
                print("\t Missing state: 9")
                print("\t", s9_time)
                print("\t", s9_orders)
                print("\t", s9_robots)
    else:
